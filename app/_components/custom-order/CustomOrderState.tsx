    ...
    <main className="min-h-screen bg-[#0a0a0a] text-white flex items-center justify-center p-4 sm:p-6">
      <div className="relative w-full max-w-md">
        ...
        <div className="relative rounded-3xl border border-white/10 bg-black/40 backdrop-blur-xl p-6 sm:p-10 text-center">
          <div className="h-14 w-14 sm:h-16 sm:w-16 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center mx-auto mb-5 sm:mb-6">
            <Icon className="h-7 w-7 sm:h-8 sm:w-8 text-zinc-400" />
          </div>
          <h1 className="text-xl sm:text-2xl font-bold font-serif mb-3">{title}</h1>
          <p className="text-sm text-zinc-400 leading-relaxed mb-8 break-words">{body}</p>
          <Link
            href="/"
            className="inline-flex h-12 w-full sm:w-auto items-center justify-center rounded-xl bg-[#4ca626] hover:bg-[#5bbd31] px-8 font-semibold shadow-[0_0_40px_rgba(76,166,38,0.25)] transition-colors"
          >
