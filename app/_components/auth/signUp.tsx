    ...
    return (
      <div className="w-full text-center max-w-xl">
        <div className="rounded-3xl border border-white/10 bg-black/40 backdrop-blur-xl p-8 shadow-2xl">
          ...
          <form onSubmit={onPressVerify} className="space-y-4 mt-4">
            <div>
            ...
            {errors?.global && (
              <p className="text-sm text-red-500">
                Error! Unable to Verify the Authentication Code. Please Try
                Again Later or with a Different Account. If it still doesn't
                work, contact us <Link href="/about-us">here</Link>
              </p>
            )}
      ...
      <div className="rounded-3xl border border-white/10 bg-black/40 backdrop-blur-xl p-8 shadow-2xl">
        ...
        <div className="mt-8 space-y-3">
          <Button
            ...
            className="inline-flex gap-5 w-full items-center justify-center rounded-xl border px-4 py-5 transition
        ...
        <form onSubmit={signUpWithPassword} className="space-y-4">
          ...
          {errors?.global && (
            <p className="text-sm text-red-500">
              Error! Unable to Proceed. Please Try Again Later or with a
              Different Account. If it still doesn't work, contact us{" "}
              <Link href="/about-us">here</Link>
            </p>
          )}
