      ...
      <div className="rounded-3xl border border-white/10 bg-black/40 backdrop-blur-xl p-6 sm:p-8 shadow-2xl w-full">
        ...
        <div className="mt-8 space-y-3">
          <button
            ...
            className="inline-flex gap-3 sm:gap-5 w-full items-center justify-center rounded-xl border px-4 py-3 text-sm sm:text-base transition
          ...
          <button
            ...
            className="inline-flex gap-3 sm:gap-5 w-full items-center justify-center rounded-xl border px-4 py-3 text-sm sm:text-base transition
              ...
              dark:bg-zinc-900 dark:text-white dark:border-zinc-800 dark:hover:bg-zinc-800"
          >
            <Microsoft className="w-5 h-5 flex-shrink-0" />
            Continue with Microsoft
          </button>
          <button
            onClick={() => oauthSignIn("oauth_apple")}
            className="inline-flex gap-3 sm:gap-5 w-full items-center justify-center rounded-xl border px-4 py-3 text-sm sm:text-base transition
              bg-zinc-100 text-zinc-900 border-zinc-300 hover:bg-zinc-200
              dark:bg-zinc-900 dark:text-white dark:border-zinc-800 dark:hover:bg-zinc-800"
          >
            <Apple className="w-5 h-5 flex-shrink-0 dark:invert" />
            Continue with Apple
          </button>
        </div>
        ...
        <form onSubmit={signInWithPassword} className="space-y-4">
          ...
          {errors?.global && (
            <p className="text-sm text-red-500">{errors.global.longMessage}</p>
          )}
        ...
        <p className="mt-6 text-center text-sm text-zinc-400">
          ...
          <Link href="/auth/sign-up" className="ml-1 text-white hover:underline">
            Sign Up
          </Link>
        </p>
      </div>
