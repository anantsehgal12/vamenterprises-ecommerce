            ...
            >
              ...
              <div className="lg:col-span-2">
                ...
                >
                  ...
                  <Card className="bg-gradient-to-b from-zinc-900 to-black border-white/10 shadow-[0_20px_80px_-20px_rgba(76,166,38,0.2)] mb-6 backdrop-blur-xl rounded-[2rem]">
                    <CardHeader>
                  ...
                  <Card className="bg-gradient-to-b from-zinc-900 to-black border-white/10 shadow-[0_20px_80px_-20px_rgba(76,166,38,0.2)] backdrop-blur-xl rounded-[2rem]">
                    <CardHeader>
                      <CardTitle className="text-white text-xl md:text-2xl font-bold">
                        {savedAddresses.length > 0
                          ? "Delivery Details"
              ...
              <div className="lg:col-span-1">
                <Card className="bg-gradient-to-b from-zinc-900 to-black border-white/10 shadow-[0_20px_80px_-20px_rgba(76,166,38,0.2)] backdrop-blur-xl rounded-[2rem] sticky top-24">
                  <CardHeader>
                  ...
                  <CardContent className="space-y-4 overflow-visible">
                    ...
                    <div className="space-y-2">
                      <Button
                        variant="outline"
                        className="w-full border-white/10 text-white hover:bg-zinc-800 h-12 rounded-xl"
                        onClick={() => router.push("/cart")}
                      >
                        Back to Cart
                      </Button>
                      <Button
                        type="submit"
                        form="customerForm"
                        className="w-full rounded-xl p-4 text-sm md:text-md cursor-pointer h-12 bg-[#4ca626] text-white hover:bg-[#5cbf32]"
