...
export const Product = pgTable("Product", {
  ...
  isOptional: isOptionalEnum("is_optional").default("No").notNull(),
...
export const CartItem = pgTable("CartItem", {
  ...
  // =========================================================
  // ADD THESE TWO COLUMNS BELOW
  // =========================================================
  price: decimal("price", { precision: 10, scale: 2 }), // Holds coupon-applied numeric price calculation

  couponCode: varchar("coupon_code", { length: 255 }), // Trackable coupon code applied at line item
